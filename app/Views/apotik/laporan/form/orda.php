              <form method="GET" id="form_orda" target="_blank">

              <div class="card card-primary card-outline">
              
                <div class="card-header with-border">
                  <h5 class="card-title m-0">G. Resep Penjamin</h5>
                </div>
                ...
                <div class="card-footer">
                  ...
                  <button type="button" id="btn_resep_pasien"  class="btn btn-primary" 
                    onClick="report('#form_orda', 'orda')">
                    <i class="fas fa-download"></i> LOAD
                  </button>

                  <button  type="button" id="btn_resep_pasien_ex" class="btn btn-success float-right" onClick="report('#form_orda', 'orda', 'true')">
