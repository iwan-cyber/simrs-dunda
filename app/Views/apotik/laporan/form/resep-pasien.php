              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      ...
                      <input class="form-control form-control-sm" id="TGL_AWAL"  name="TGL_AWAL" type="text" value="<?php echo date("d-m-Y"); ?>">
                    </div>

                    <div class="col-6">
                      <label class="control-label" for="TGL_AKHIR">Sampai Dengan</label>
                      <input class="form-control form-control-sm" id="TGL_AKHIR"  name="TGL_AKHIR" type="text" value="<?php echo date("d-m-Y"); ?>">
                    </div>
                ...
                <div class="card-footer">
                  ...
                  <button 
                    ...
                    onClick="report('#form_daftar_resep', 'daftar_resep', 'true')">
