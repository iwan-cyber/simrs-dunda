              <form method="GET" id="form_obat_keluar" target="_blank">

              <div class="card card-primary card-outline">
              
                <div class="card-header with-border">
                  <h5 class="card-title m-0">D.Rekap Total Pengeluaran Obat Unit Apotik</h5>
                </div>
                ...
                <div class="card-footer">
                  ...
                  <button 
                    ...
                    onClick="report('#form_obat_keluar', 'obat_keluar')">
                  ...
                  <button 
                    ...
                    onClick="report('#form_obat_keluar', 'obat_keluar', 'true')">
