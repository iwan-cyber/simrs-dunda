    ...
    <div class="card">
        ...
        <div class="card-block">
            ...
            <div class="row">
                ...
                <div class="col-md-6">      
                <label for="UNIT" class="col-form-label col-form-label-sm">Unit Pengeluaran</label>
                <select class="form-control form-control-sm select" id="UNIT" name="UNIT" required="">
                </select>
                </div>
