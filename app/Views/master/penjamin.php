      ...
      <div class="modal-body">
        ...
        <form id="form">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="ID" name="ID" aria-describedby="id penjamin" placeholder="Otomatis" readonly="">
            </div>
            <div class="form-group">
                <label for="PENJAMIN">PENJAMIN</label>
                <input type="text" class="form-control" id="PENJAMIN" name="PENJAMIN" placeholder="Ketik Nama Penjamin">
            </div>
        </form>
      </div>
...
<script>
    const url = '<?= base_url('master/penjamin'); ?>';
</script>
<script src="<?= base_url('app/master/penjamin.js?'.rand()); ?>"></script>