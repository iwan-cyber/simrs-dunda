    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="form">
            ...
            <div class="form-group">
                <label for="KELOMPOK_PEGAWAI">KELOMPOK PEGAWAI</label>
                <input type="text" class="form-control" id="KELOMPOK_PEGAWAI" name="KELOMPOK_PEGAWAI" aria-describedby="Kelompok pegawai" placeholder="isikan Kelompok Pegawai">
            </div>
        </form>
      </div>
...
<script>
    const url = '<?= base_url('master/pegawaiKelompok'); ?>';
</script>
<script src="<?= base_url('app/master/pegawaiKelompok.js?'.rand()); ?>"></script>
