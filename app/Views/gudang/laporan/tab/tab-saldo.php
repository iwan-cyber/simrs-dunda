<form method="GET" id="form_saldo" target="_blank">
	<div class="card card-primary card-outline">

		<div class="card-header with-border">
			<h5 class="card-title m-0">E. Saldo</h5>
		</div>
		...
		<div class="card-body">
			...
			<div class="row">
					...
					<div class="form-group col-2">
						...
						<button type="button" onclick="Laporan.print('saldo')" class="btn btn-primary btn-flat btn-sm">Ambil Data</button>
					</div>
